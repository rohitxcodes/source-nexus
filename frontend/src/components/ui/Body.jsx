  ...
  return (
    <>
      <div className="wrapper py-10">
        ...
        <div className="box flex py-10 px-10">
          <div className="ele flex">
            ...
            <div className="mask">
              <img className="inset-y-3" src={gamingImg} alt="gaming" />
            </div>
          </div>
          ...
          <div className="ele flex">
            <div className="mask">
              <img className="inset-y-3 h-full" src={youImg} alt="you" />
            </div>
            <div className="intro-text text-5xl text-center">
      ...
      <div className="wrapper1">
        <h1
          className="text-black text-8xl text-center py-10"
